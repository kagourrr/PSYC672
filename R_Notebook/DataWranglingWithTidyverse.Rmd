...
```{r ex1_solution}
# Your code here
#let's transpose state names to a column, filter the rows displayed by UrbanPop>80, and select states that have Murder and Rape arrests. Then we can arrange the dataset by descending Murder rates.
USArrests %>%
...
```
**Describe the result:**
Through our data filtering and reshaping, we can see that Nevada, New York, and Illinois are the US states that have the highest rates of murder arrests. 
